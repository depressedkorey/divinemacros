...
You can also view and manage your key at any time on your dashboard:
  https://divinemacros.store/dashboard.html
...
def _send_referrer_dm(affiliate_code: str, buyer_discord_id: str, plan: str) -> None:
    ...
    embed = {
        ...
        'description': (
            ...
            '💜 Thank you for supporting Divine Macros!'
        ),
...
def _send_purchase_dm(discord_id: str, plan: str, product_name: str | None = None) -> None:
    ...
    embed = {
        ...
        'description': (
            ...
            '⭐ **Enjoying Divine Macros?** Use `/rating` in our Discord server to leave a review — it means the world to us!'
        ),
        'footer': {'text': 'Divine Macros • Thank you for your support!'},
    }
...
def _post_sale_notification(discord_id: str, plan: str, charged_cents: int,
    ...
    if is_standalone:
        ...
        footer_text = 'Divine Macros • Individual Macros'
    else:
        normalized_plan = _normalize_checkout_plan(plan)
        if normalized_plan == 'lifetime_core':
            ...
            plan_label = 'Core'
            plan_color = 0x6366f1
        title = '🎉 New Sale — Divine Macros'
        footer_text = 'Divine Macros • Purchase System'
